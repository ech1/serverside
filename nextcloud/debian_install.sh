##########################################################################################
#!/bin/bash
# (c) Carsten Rieger IT-Services (Debian 10.4+ 64BIT)
# Nextcloud 19+
# Version 200625: 
...
echo "deb http://mirror2.hs-esslingen.de/mariadb/repo/10.4/debian $(lsb_release -cs) main" | tee mariadb.list
...
apt install php7.4-fpm php7.4-gd php7.4-mysql php7.4-curl php7.4-xml php7.4-zip php7.4-intl php7.4-mbstring php7.4-json php7.4-bz2 php7.4-ldap php-apcu php7.4-gmp php7.4-bcmath imagemagick php-imagick php-smbclient -y
